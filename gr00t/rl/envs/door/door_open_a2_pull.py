    ...
    def _register_a2_pull_staged_reset_buffers(
        ...
        for name in names:
            ...
            self._register_buffer_to_track(
                ...
                dtype=tensor.dtype,
                # Keep all pull named snapshots on host with their full capacity;
                # live tensors and robot/door articulation snapshots remain on GPU.
                storage_device="cpu",
            )

...
class PullV6PostReleaseObsOverrideActor(PullV6ReleaseModeActor):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.post_release_obs_override = nn.Linear(135, len(self._D_ACTION_INDICES))
    ...
    def _apply_post_release_override(
        ...
        mean = mean.clone()
        d_mask = release_mode[..., 1].unsqueeze(-1) == 1
    ...
    def _mean_from_memory(
        ...
        return self._apply_post_release_override(mean, current_obs, release_mode)

...
def _get_material_randomization():
    ...
    from groot.rl.isaac_utils.playground.scripts.material_randomization import (
...
from groot.rl.isaac_utils.playground.utils.math_utils import Rotation, set_prim_transform
from groot.rl.isaac_utils.playground.utils.usd_utils import (
    add_collider,
    add_mass,
    add_rigid_body,
    create_plane,

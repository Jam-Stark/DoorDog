...
当前包含 origin reference memory 与 A2_Piper development memory。
...
origin reference memory 只保存可复用的 origin/source-of-truth 事实与已知 caveat。Future migration、target implementation progress、debug 施工日志、实验结果应创建并维护在 A2_Piper 或其他独立 memory subsystem。

...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-24 06:41 HKT — v18 P1/P2/M39/M41 preflight、strict admission与formal startup均有verified evidence：P1 G5 baseline与P2 zero-intervention provenance已归档；exact M39 1.2/1.0因`upper_dof_overspeed` admission FAIL，narrowed 1.1/0.9/0 r9 strict runtime PASS。formal v18 main已启动并RUNNING（local W&B offline），不是training完成或policy-quality结论；500/1000/1500/2000 audits、endpoint canonical/48-door/renders、P1 slip reduction与reward carry/decomposition judgement仍pending。

...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-21 22:56 HKT — base_v16 M29–M32 delivery candidate已通过CODE_QUALITY、IsaacLab static semantics与CPU/no-sim QA；v14/v15保留80–120kg、corridor关闭/0.1与linear body penalty，v16显式选择80–160kg、corridor开启/0.4与quadratic penalty。schema-v2 reporter覆盖M32 mass buckets与完整M33 endpoint metrics。formal v16训练、实际mass histogram/48-record M33与smoke natural-exit独立证据仍NOT RUN/UNVERIFIED；下一步为matched A(80–120) / B(80–160)训练。

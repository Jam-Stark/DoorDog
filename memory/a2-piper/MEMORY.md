...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-21 00:21 HKT — v14 step2000 M20 supplementary seed1/2及combined 48-door report已完成：48/48 goal/stage5，非canonical statistical proof；v15已完成M23 1.10m policy-driven release、M24–M27 implementation与post-fix natural-exit smoke。formal v15 3000-batch training、matched iter500/1000/2000 eval及seed1/2 endpoint report仍NOT RUN。

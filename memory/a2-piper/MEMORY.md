...
- [base-v22-posture-clearance/description.md](base-v22-posture-clearance/description.md): base_v22 revision-3 conditional posture / clearance strategy / hinge randomization / body-assist 轮次的 plan identity、admission chain、source facts 与执行进度。

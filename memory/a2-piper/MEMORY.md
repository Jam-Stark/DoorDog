...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-07-28 23:06 HKT — C-B v16 Student one-update 与 physical GPU7→logical `cuda:0` 的 32-env/10-batch capacity/stability pilot 已完成（`V16_CB_GPU7_CAPACITY_STABILITY_PASS`），checkpoint `global_step=10` 可加载；natural Kit close、正式 longer-scale/multi-seed training、policy quality 与 eval/export 仍开放。

...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-20 02:57 HKT — v14 step2000 height-stratified/matched endpoint被选为render checkpoint：16/16 goal/crossing、bilateral 95.947605%、coasting 4.011461%、hinge p95 .491563；j8 26.156365%高于25% observation line、低于>30% reopen trigger。seed exporter已修复并runtime验证；seed1/2 supplementary、combined 48-door M20与formal launcher natural-exit仍NOT RUN。

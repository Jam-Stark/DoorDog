...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-24 20:32 HKT — v18 formal 4×1024 training natural exit0、step2500/2500与checkpoint provenance已验证；midpoint/3-seed×16 strict endpoint/render analysis已关闭。endpoint canonical/pooled goal `13/16`/`40/48`、crossing-held `41/48`、corridor slip仅降至baseline `96.57%`且held≥1.5为`0/44`，故v18 non-promotable、无continuation，v17 G5 step2500继续作为release reference。

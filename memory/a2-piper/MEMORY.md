...
- [base-v26-scratch-bilateral-teacher/description.md](base-v26-scratch-bilateral-teacher/description.md): 2026-08-25 10:54 HKT — v26-2 `v26_2_complete_not_admitted`：C/A/R/W Wave1 均从 `CONT_STEP2000` policy-only + inherited actor RMS 完成750 PASS；24/24 natural Route A evaluations 每侧 exact64。W_STEP0750 Stage3 retention passed（LEFT `32/64`、RIGHT `36/64`），但第二个 admission/creation gate failed：Stage4 `0/64`、handle/hinge admission `0`、integrity `0`；typed `HANDLE_CREATION_NOT_SUPPORTED`。R→W `WALL_REMOVAL_NOT_SUPPORTED_IN_PUSH`；conditional relay 未运行，selected render 为 Stage2/no goal，Teacher/Student 不更新。

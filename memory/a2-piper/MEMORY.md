...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-07-30 17:34 HKT — C-B2 原 ±15° 与独立 ±20° toe-in 的 v16 Teacher process-video runtime/decode gates PASS，但 panorama 均因明显重影、撕裂和空洞保持视觉 FAIL；±20° 空洞率为 `27.08%`，较 ±15° 增加 `4.11pp`。C-B v16 GPU7 capacity training 结论不变，panorama 重构、Stage5-aware view、physical/real validation 与 Student integration 仍开放。

...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-07-28 20:58 HKT — C-B v16 Student one-update 已完成并保存 checkpoint（`V16_CB_STUDENT_ONE_UPDATE_PASS`）；Doorman paper Phase2 Student Distillation / DAgger vision policy 的 A2+Piper 替代/适配计划仍覆盖 teacher checkpoint、student obs/action、vision camera、A2_Base trainer compose、object prediction、eval/export 与 validation gates。

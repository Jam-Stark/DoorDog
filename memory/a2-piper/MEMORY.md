...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 2026-07-18 22:13 HKT — `base_v13_1_main` formal saved runtime完成到step3000（4×1024、global batch4096、save250）；step3000 matched eval为16/16 goal/stage5/complete，env0/1 render产出6个可逐帧解码的720p/20fps视频。下一步做objective review并决定promotion或conditional ablation，不自动启动新训练。

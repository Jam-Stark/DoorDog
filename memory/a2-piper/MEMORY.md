...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-07-30 16:13 HKT — C-B2 三相机与 v16 Teacher process-video runtime gates PASS，但 panorama 因明显重影、撕裂和空洞被用户判定视觉 FAIL；C-B v16 GPU7 capacity training 结论保持不变。Panorama 重构、Stage5-aware view、CAD/physical calibration/real sync、mirrored left/out、Student integration 与 eval/export 仍开放。

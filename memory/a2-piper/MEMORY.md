...
- [pull-open-door-task/description.md](pull-open-door-task/description.md): 2026-08-12 07:45 HKT — pull-v5 bridge-occupancy/release-persistence round closed without reaching its stopping condition. Runtime census PASS proves v4-B reset mass is early-open (Stage0/1/2/3/4/5=`12800/64/64/64/64/0`; Stage4 hinge mean `.252803`, range `.250109–.256819`), while Source A exported 64 settle-valid E5 states but no usable canonical bank was built because Source B failed. P1 anchor+door is BLOCKED, P2 INCONCLUSIVE, and P3/P4/G2 are NOT_RUN. Formal review provenance remains FAIL; targeted r3–r5 repairs/runtime evidence are not a second reviewer PASS. Future occupancy/traversal work must first satisfy the recorded builder, metadata, capture, independence, and load-only prerequisites.

...
- [base-v23-force-feasibility/description.md](base-v23-force-feasibility/description.md): 2026-08-10 01:30 HKT — base_v23 P0 的 `INTERIM_TYPED_ADJUDICATION / FORMAL_NO-GO`；P0.2/P0.4 raw/P0.5 bands 与 R49 typed-negative certificate 已有事实，R54 D1 capability-source reducer 为 `D1_CAPABILITY_SOURCE_INCOMPLETE`，仅允许受限 D0 preparation DAG。

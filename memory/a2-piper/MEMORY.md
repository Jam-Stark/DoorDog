...
- [base-v24-friction-force-boundary/description.md](base-v24-friction-force-boundary/description.md): base_v24 P0/P1 与 P2 r12 已完成；当前合法终局为 `V24_E1_DENOMINATOR_INSUFFICIENT_POST_F3`，P3/science waves 不准入，仅剩 R1 F3 measurement-only RQ4 closure。

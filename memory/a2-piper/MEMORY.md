...
- [base-v26-scratch-bilateral-teacher/description.md](base-v26-scratch-bilateral-teacher/description.md): 2026-08-21 18:37 HKT — v26 已启动 clean scratch bilateral Teacher 实现；R0 固定 exact LR、door-relative far start、symmetric privileged side one-hot、fresh per-env staged reset 与 acquisition-first reward。当前尚无 Isaac Sim/训练 PASS。

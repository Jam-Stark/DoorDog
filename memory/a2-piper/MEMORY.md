...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-08-09 02:59 HKT — ToeOut6/pitch−50° sealed G2 Stage0 contract runtime PASS：fixed true Teacher seed0/16-env/one-episode 为 `16/16` stage5/complete，matched pure Student 为 `13/16`，remaining env `4,6,9` 为 Stage2 `stage_overtime`。该结果不外推为 multi-seed/general policy PASS；没有 Student finetune，Stage2 diagnosis 保持独立后续 scope。

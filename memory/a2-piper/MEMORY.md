...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 从 `base_v9` 起独立负责 A2+Piper full-stage 推门/开门 RL optimization，继承 base_v0→v8 经验并维护当前 baseline、训练/eval/render contract 与 `base_v10` approval-gated TODO。
- [pull-open-door-task/description.md](pull-open-door-task/description.md): A2+Piper pull-only door task 的静态方向、pipeline 与 runtime verification 边界。

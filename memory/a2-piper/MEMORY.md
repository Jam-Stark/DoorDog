...
- [base-v24-friction-force-boundary/description.md](base-v24-friction-force-boundary/description.md): base_v24 已执行 Owner friction-domain escalation；P1-lite 证实 `2..20 N·m` 稳定，r13 Rule16/384-row calibration 完成并在注册 gradient gate 到达 Owner stop。artifact 为 `V24_FRICTION_AXIS_NONDISCRIMINATIVE`，但行为 progress 梯度为 96/96，科学解释待 Owner；F3′/P3/science waves 未准入。

...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 从 `base_v9` 起独立负责 A2+Piper full-stage 推门/开门 RL optimization；`base_v11` incomplete-budget matched eval 已完成、没有 breakthrough；下一步是 approval-gated `base_v12` full-state resume H+ proposal。

...
- [pull-open-door-task/description.md](pull-open-door-task/description.md): 2026-08-12 00:07 HKT — handoff preparation completed: `a2_piper_pull_v1_to_v4_evidence_20260811.zip` is an untracked 108,407,774-byte derivative excerpt (120 entries; Tier1 97, Tier2 22; six explicit R1 logical video omissions) with `scriptsFORhuman/pull_v4/MANIFEST.md`, `scriptsFORhuman/pull_v4/build_pull_v1_v4_evidence.py`, and source renders under `logs_eval/a2_piper_pull_v4/renders/`. Four unavailable v2 full runner logs remain omitted without substitution. R1 is INCONCLUSIVE/NOT_RUN after three launcher attempts, not a policy or product-runtime verdict; R2-R4 natural-exited with six full-decode 1280×720@20fps MP4s each. Original evidence units are untouched and no behavior-success claim is made. Pull-v4 remains the prior negative closure; v5 requires separate planning.

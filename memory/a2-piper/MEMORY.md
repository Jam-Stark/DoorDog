...
- [pull-open-door-task/description.md](pull-open-door-task/description.md): 2026-08-15 03:08 HKT — pull-v5.2 closed under G3/G11 after three complete 64-row natural narrow-anchor attempts. Rule 5 now requires terminal current-state waypoint+yaw retention for only the used S1–S4 sequences; the v5.1 S1/S2 yaw PASS was an initialization latch. All sequences stayed command-solvable, but final attempt waypoint/yaw was `7/11/10/8` and `1/0/1/5`, so door buckets/G2/P3/P4/dual-source eval are NOT_RUN with no passage denominator. The sole formal review remains FAIL with targeted fixes/runtime evidence and no second reviewer PASS; inherited v5.1 P2/F5/G8 facts remain version-scoped.

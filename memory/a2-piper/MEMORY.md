...
- [base-v24-friction-force-boundary/description.md](base-v24-friction-force-boundary/description.md): base_v24 friction-calibrated force boundary、posture 力价值终裁、arm-base coupling groundwork 与 gated-posture 研究主线；当前从 P0 v23 descriptive posthoc 与统一单位契约开始。

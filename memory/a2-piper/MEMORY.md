...
- [push-open-door-optimization/description.md](push-open-door-optimization/description.md): 从 `base_v9` 起独立负责 A2+Piper full-stage 推门/开门 RL optimization；`base_v10` scratch A/B/C/D 已完成 matched eval，当前只保留 approval-gated `base_v11` minimal RL proposal。

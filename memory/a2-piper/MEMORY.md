...
- [phase2-student-distillation-a2-piper/description.md](phase2-student-distillation-a2-piper/description.md): 2026-08-10 19:39 HKT — ToeOut6/pitch−50° fixed-G2 large-scale eval complete：Student `459/512 = 89.65%`，true-action Teacher `255/256 = 99.61%`，gap `9.96 pp`；Stage2 contact-continuity 仍是 dominant failure signal，但 direct visual metrics 为 `0/768`，camera/perception attribution 保持 `UNKNOWN/INCONCLUSIVE`，verdict 为 `(c) 混合 / 暂归类`。没有训练授权；direct-visibility/D435-depth ablation、wrist-camera decision 与 targeted Stage2 DAgger 都需 separately approved scope，且无 determinism/generalization/deployment/lifecycle/physical-camera PASS。

...
- H15已关闭；H16 active seeds为0/1/2，其中seed2已conditional admit进入Stage3，seed0/1等待M750。M1000要求Stage3 reward非零且双方出现E3或明确handle/latch趋势；GPU0用于paired Stage1-occupancy successor。

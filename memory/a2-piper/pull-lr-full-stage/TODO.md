...
- H15 current scheduled candidate smoke已通过；四卡并行启动4个随机初始化seed，每个单进程不中断到global1500并保存25-step checkpoints，禁止把中途checkpoint resume误写成bank-preserving continuation。

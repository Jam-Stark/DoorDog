...
- 2026-07-02 21:23 HKT - `30N` effort-only ablation 已完成且结果负向；下一步 stage0-2 reward/actuator/staging/height ablation 仍以 `replay_v2` 为 baseline，但应优先设计 gripper primitive / close-stage shaping 或 stage1/base-creep 约束，不要继续单独提高 gripper effort limit。

...
- 2026-07-02 16:17 HKT - 暂停验证 `arm_j7/j8=80` + gripper effort limit `30N` actuator trial；先运行 `restrictPre-Grasp_v2` reproduction control config（yaml-driven v2 actual-equivalent：`arm_j1..j5=80/4`、`arm_j6=60/3`、`arm_j7/j8=40/1`、gripper effort `10.0`），再判断是否恢复更高 gripper force trial。

...
- 2026-07-02 21:31 HKT - 下一轮 retrain/eval 以 `replay_v2` 为 baseline，验证当前 arm Kp/Kd ablation：`arm_j7/j8 effort_limit_sim=10.0/10.0`、`arm_j1=64/3`、`arm_j2=128/4.5`、`arm_j3..j6=64/3`、`arm_j7/j8=40/1`；reward/gate 不变，重点看 stage1 arm reach vs base creep 与 stage2 close behavior。

...
- 2026-07-02 18:41 HKT - 下一轮 retrain/eval 只验证 gripper effort `10.0 -> 30.0` 单变量变化：A2 Piper Kp/Kd 保持 v2 actual-equivalent（`arm_j1..j5=80/4`、`arm_j6=60/3`、`arm_j7/j8=40/1`），stage0 offset 保持 `0.70`，online handle height 保持 `0.85~0.95m`。

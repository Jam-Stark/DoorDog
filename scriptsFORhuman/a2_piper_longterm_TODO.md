...
当前补充：2026-09-18 20:45 HKT；Owner/v29 D023明确baseline暂不做按需回弹恢复，三处奖励精确恢复D021之前原公式；强回弹时重新抓把手扶门及相关奖励/回臂协调归N02讨论，非baseline前置。候选与证据边界见[N02讨论记录](novelty/documents/20260918_n02_regrasp_rebound_discussion.md)，无新方法实现或实验预算。
...
| **N-02 交互历史：继续传感/可辨识性立项设计（CONTINUE）** | 2026-09-18 D023追加强回弹后重抓把手扶门及奖励/回臂协调讨论，首版仅重抓把手，方案未实施；[候选](novelty/documents/20260918_n02_regrasp_rebound_discussion.md)。2026-09-17增量复核：明确proprio/action history/qpos/effort可读性，保留短集/失败集并按物理质量/摩擦、侧别、暴露分层。有限域pilot须独立范围/预算，执行DEFER；v28资格未确认不否定该方法，最终相机/CAD不作无限前置 | R节方向1；v28 D045/D059；[增量复核](novelty/documents/20260917_v28_closure_N01_N02.md) |

...
| X-05 | N-01 先决定是否重新立项 pilot、重设计扰动与 loss，再按新 pilot 证据考虑多 seed；N-02 复核可部署传感、可辨识性与适用门域，明确继续/延期/关闭。v27 Q_R 为 UNRESOLVED，门域未收敛，不等待旧 PROMISING 或无限等待完美 Teacher | D-01、D-38 | v28 closure 成功或失败均触发 planner 复核；具体实验另行授权 | 主线下一阶段 planner | D 节 N-01/N-02 | OPEN |

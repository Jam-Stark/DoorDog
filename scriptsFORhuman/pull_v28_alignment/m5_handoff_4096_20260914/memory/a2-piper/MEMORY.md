...
- [pull-v28-baseline-sync/description.md](pull-v28-baseline-sync/description.md): 2026-09-14 — D016三seed4096重建交接；P2 18/18与G0 10/32保留，旧1024共3860已停止；新S1初始化取消、S2/S3未启动，等待m5 AI按prompt执行，无新commit/push。
...
- [pull-lr-full-stage/description.md](pull-lr-full-stage/description.md): 2026-09-08 21:27 HKT — P1两源各100batches完成（13,107,200 transitions），B实际写入/加载已证实但高margin B/C/ready/clean为0；Stage1/2持续限位外target与极少j3恢复已测量。报告见pull_v7/P1_EXPOSURE_REPORT.md；资源关闭、无新eval或promotion，P2未选，迁移保持关闭。

...
def build_b4_pilot_plan(
    ...
    *,
    ...
    if materialization.get("adaptation_bundle_sha256") is not None:
        raise V21BError("B4 pilot POST_CENSUS materialization adaptation identity must be null")
    ...
    argv = [
        ...
        "env.config.a2_v21B_adaptation_bundle_sha256=null", "+v21b_adaptation_bundle_sha256=null",
...
def adjudicate_b4_pilot(
    ...
    *,
    ...
    for key in ("cell", "seed", "materialization_phase", "materialization_sha256", "materialized_config_sha256", "source_checkpoint_sha256", "source_lock_sha256", "source_config_sha256", "adaptation_bundle_sha256", "raw_metrics_path", "source_lock_path", "source_lock_file_sha256"):

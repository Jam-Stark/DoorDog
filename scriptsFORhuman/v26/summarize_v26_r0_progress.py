...
def _keep_metric(name: str) -> bool:
    return (
        name in {
            ...
            "Env/a2_stage2_gripper_close_command_frac",
            "Env/a2_stage2_negative_gripper_primitive_frac",
            "Env/a2_stage2_streak_ge_K_frac",
            "Env/a2_stage2_gripper_raw_sign_flip_frac",
            "Env/a2_stage0_to1_staging_standoff_p50",
            "Env/a2_stage0_to1_staging_standoff_p95",

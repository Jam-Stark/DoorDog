...
case ${1:-} in
  ...
  probe)
    ...
    launch v26_5_wave1_r1_runtime_contract_attempt3 2 "$command" "$runtime_logs/runtime_contract_attempt3.log" "$stage/K/runtime_contract.json"
    ;;
  smoke)
    [[ $# -eq 2 && ${2:-} == --launch ]] || { usage >&2; exit 2; }
    require_static; require_pass v26_5_wave1_r1_runtime_contract_attempt3; gpu_idle 2
  ...
  train)
    [[ $# -eq 2 && ${2:-} == --launch ]] || { usage >&2; exit 2; }
    require_static; require_pass v26_5_wave1_r1_runtime_contract_attempt3; require_pass v26_5_wave1_r1_smoke
  ...
  diagnostic)
    [[ $# -eq 2 && ${2:-} == --launch ]] || { usage >&2; exit 2; }
    require_static; require_pass v26_5_wave1_r1_runtime_contract_attempt3; require_pass v26_5_wave1_r1_smoke; gpu_idle 7

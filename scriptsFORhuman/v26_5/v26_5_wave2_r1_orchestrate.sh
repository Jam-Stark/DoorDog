...
run_id=v26_5_wave2_r1_policy_residual_20260830_r8; stage="$repo/logs_eval/base_v26/$run_id"; static="$stage/M/static"; registry="$static/command_registry.json"; resolved="$static/resolved_configs"; eval_root="$stage/eval"; train_root="$repo/logs_rl/by_batch/base_v26/$run_id/formal"; runtime_logs="$repo/scriptsFORhuman/v26_5/runtime_logs/$run_id"

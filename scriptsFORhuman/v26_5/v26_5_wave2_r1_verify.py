...
def main() -> None:
    ...
    k1=r.get("K1",{}); require(k1.get("trace_reward_terms")=={"control":["push_door_handle","a2_stage3_unlatch_hold","push_door_hinge","a2_stage3_stage4_hold_and_drive"],"dual":["a2_stage3_handle_creation","a2_stage3_unlatch_hold","push_door_hinge","a2_stage3_stage4_hold_and_drive"]}, "K1 view-specific trace reward-term contract mismatch")
    paths={}
